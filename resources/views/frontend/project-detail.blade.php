...
{!! json_encode(app(\App\Services\SeoService::class)->generateProjectSchema($project), JSON_UNESCAPED_SLASHES | JSON_UNESCAPED_UNICODE | JSON_PRETTY_PRINT) !!}
</script>
<script type="application/ld+json">
{!! json_encode(app(\App\Services\SeoService::class)->generateBreadcrumbSchema([
    __('common.home') => route('home'),
    __('common.projects') => route('projects'),
    $project->title => route('projects.detail', $project->slug),
