...
@section('title', 'Yeni Sabit Sayfa Ekle')

@section('content')
@include('admin.partials.page_header', [
    'title' => 'Yeni Sabit Sayfa Ekle',
    'subtitle' => 'Sisteme yeni bir kurumsal veya bilgilendirme sayfası tanımlayın.',
    'icon' => 'fa-plus',
            ...
            <div class="admin-card-glass p-4">
                ...
                <div class="d-flex gap-2 pt-2">
                    <button type="submit" class="btn btn-enterprise-admin w-100 py-2">
                        <i class="fa-solid fa-floppy-disk me-1"></i> Sayfayı Kaydet
                    </button>
